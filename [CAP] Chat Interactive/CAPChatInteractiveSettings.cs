...
namespace CAP_ChatInteractive
{
    ...
    {
        // Existing properties...
        public string modVersion = "1.50";  // Current mod version WE DONT SAVE THIS! Used in history control
        ...
        public float KarmaDecayRate = 0f;    // % of CURRENT karma lost per decay tick 
